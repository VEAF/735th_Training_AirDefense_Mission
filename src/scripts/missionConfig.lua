...
table.insert(veafMove.Tankers, "Shell1")
table.insert(veafMove.Tankers, "Texaco1")
table.insert(veafMove.Tankers, "Texaco3")
table.insert(veafMove.Tankers, "Texaco4")
