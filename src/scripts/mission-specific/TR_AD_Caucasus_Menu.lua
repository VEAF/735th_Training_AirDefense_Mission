...
-- Function to activate BFM Area Tu-95 Bomber Wave 1 / 9 passive Tu-95
local function BFM_Bomber_Activate_Scenario1()
  MESSAGE:New( "Tu-95 Bomber wave scenario 1 - activated",  25):ToAll()
  local Wave11 = SPAWN:New("Red Tu-95 Bomber Wave1-1"):Spawn()
  local Wave12 = SPAWN:New("Red Tu-95 Bomber Wave1-2"):Spawn()
  local Wave13 = SPAWN:New("Red Tu-95 Bomber Wave1-3"):Spawn()
  local Wave14 = SPAWN:New("Red Tu-95 Bomber Wave1-4"):Spawn()
  local Wave15 = SPAWN:New("Red Tu-95 Bomber Wave1-5"):Spawn()
  local Wave16 = SPAWN:New("Red Tu-95 Bomber Wave1-6"):Spawn()
  local Wave17 = SPAWN:New("Red Tu-95 Bomber Wave1-7"):Spawn()
  local Wave18 = SPAWN:New("Red Tu-95 Bomber Wave1-8"):Spawn()
  local Wave19 = SPAWN:New("Red Tu-95 Bomber Wave1-9"):Spawn()
end

-- Function to activate BFM Area Tu-95 Bomber Wave 2 / 9 defensive Tu-95
local function BFM_Bomber_Activate_Scenario2()
  MESSAGE:New( "Tu-95 Bomber wave scenario 2 - activated",  25):ToAll()
  local Wave21 = SPAWN:New("Red Tu-95 Bomber Wave2-1"):Spawn()
  local Wave22 = SPAWN:New("Red Tu-95 Bomber Wave2-2"):Spawn()
  local Wave23 = SPAWN:New("Red Tu-95 Bomber Wave2-3"):Spawn()
  local Wave24 = SPAWN:New("Red Tu-95 Bomber Wave2-4"):Spawn()
  local Wave25 = SPAWN:New("Red Tu-95 Bomber Wave2-5"):Spawn()
  local Wave26 = SPAWN:New("Red Tu-95 Bomber Wave2-6"):Spawn()
  local Wave27 = SPAWN:New("Red Tu-95 Bomber Wave2-7"):Spawn()
  local Wave28 = SPAWN:New("Red Tu-95 Bomber Wave2-8"):Spawn()
  local Wave29 = SPAWN:New("Red Tu-95 Bomber Wave2-9"):Spawn()
end

-- Function to activate BFM Area Su-25 Bomber Wave 1 / 4 guns only Su-25
